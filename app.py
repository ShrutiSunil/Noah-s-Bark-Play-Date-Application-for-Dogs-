...
def play_data(n, v, o, g, a, b, w, c, bo, d, t, l, ap, wh, own, dog, be, y, ad, ow, dw, go):
    ...
    #read the csv file
    df = pd.read_csv(r"C:/Users/Shruti Sunil Nair/OneDrive/Desktop/PlayDate/PlayDate/Doggo.csv")
...
def collabrative(input1,display):
    import pandas as pd
    df = pd.read_csv(r"C:/Users/Shruti Sunil Nair/OneDrive/Desktop/PlayDate/PlayDate/Doggo.csv")
    df1 = pd.read_csv(r"C:/Users/Shruti Sunil Nair/OneDrive/Desktop/PlayDate/PlayDate/Userssearch.csv")
